...
import com.komshop.data.OAuth1.OauthConstants.ParameterList;
import com.komshop.data.OAuth1.services.HMACSha1SignatureService;
import com.komshop.data.OAuth1.services.TimestampServiceImpl;
...
public class OAuth1Interceptor implements Interceptor {
   ...
   * */
    ...
    private OAuth1Interceptor(String consumerKey, String consumerSecret) {
    ...
    public static final class Builder {
        ...
        public OAuth1Interceptor build() {
            ...
            return new OAuth1Interceptor(consumerKey, consumerSecret);
        }
    }
